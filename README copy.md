...
Plataforma fullstack construída com **ASP.NET Core 8 Blazor WebAssembly**, SQL Server em container Docker, e um visual inspirado no efeito **"Google Anti-Gravity"**.
...
5. **Seed dos dados**: roles (Admin/Client), admin user, 6 problemas, 3 developers
