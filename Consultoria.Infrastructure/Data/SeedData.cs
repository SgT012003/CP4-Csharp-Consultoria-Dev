    ...
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        if (!context.Developers.Any())
        {
            context.Developers.AddRange(
                new Developer { Name = "Carlos Silva", Phone = "5511999990001", Email = "carlos@consultoria.com", Specialization = "Backend .NET", IsAvailable = true },
                new Developer { Name = "Ana Souza", Phone = "5511999990002", Email = "ana@consultoria.com", Specialization = "Frontend Blazor", IsAvailable = true },
                new Developer { Name = "Pedro Lima", Phone = "5511999990003", Email = "pedro@consultoria.com", Specialization = "DevOps & Docker", IsAvailable = true }
            );
